 ...
 */
const PX_PER_POINT = 120;           // space you want for each day
...
const Forecast: React.FC<ForecastProps> = ({ forecast }) => {
  ...
  /* minimum width needed so the curve isn't squashed */
  ...
  return (
    /* 1. outer wrapper enables side-scroll on small screens */
    <div style={{ overflowX: 'auto', WebkitOverflowScrolling: 'touch' }}>
      {/* 2. inner wrapper   — NEW line is width / minWidth */}
      <div style={{ width: '100%', minWidth: chartMinWidth, height: 220 }}>
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            {/* hidden axis to give vertical breathing room */}
